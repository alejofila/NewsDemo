...
class NewsListPresenterTest{
    ...
    @Test
    fun `when repository returns zero news should call showNoMessage`(){
    ...
    @Test
    fun `when repository returns a list of one news should call showNewsList`(){
        val newsMock = News("","","")
    ...
    @Test
    fun `when repository returns a list of multiple news should call showNewsList`(){
        val newsMock = News("","","")
